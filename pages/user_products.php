                ...
                <div class="panel panel-success panel-size-custom">
                        <div class="panel-body">
                            ...
                            <?php
                                ...
                                <div class="title"><h1 align="center">Request URL</h1></div>
  ...
  //  $supplier=$_POST['supplier'];
   // $prod_serial=$_POST['prod_serial'];
    ...
    if(empty($prod_name) || empty($prod_desc)  ||   empty($category) 
        ...
        $query = "INSERT INTO req (reqname, reqdesc, category,img) 
        VALUES ('$prod_name','$prod_desc','$category','$prod_pic1')";  
          ...
          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    <label for="prod_name">Product Name You Wished:</label>
                    <input type="text" class="form-control" id="prod_name" name="prod_name" placeholder="Product Name"/>
                    <label for="prod_desc">Product Description (With Webaddres):</label>
